package com.toxin.gotox.controls;
...
public class JoyStick extends Group {
    ...
    public JoyStick(float minHeight) {
        idle = new Image(GoTox.atlas.findRegion("joystick"));
        addActor(idle);
        ...
        right = new Image(GoTox.atlas.findRegion("joystick_right"));
        right.setSize(getWidth(), getHeight());
        addActor(right);

        left = new Image(GoTox.atlas.findRegion("joystick_left"));
