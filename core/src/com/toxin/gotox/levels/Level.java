package com.toxin.gotox.levels;
...
import com.toxin.gotox.controls.CButton;
import com.toxin.gotox.controls.JoyStick;
import com.toxin.gotox.controls.JumpGauge;
import com.toxin.gotox.player.IBody;
import com.toxin.gotox.player.Player;
import com.toxin.gotox.player.UserData;
import com.toxin.gotox.screens.LevelCompletedScreen;
...
public class Level extends StageGame{
    ...
    public Level(String directory) {
        ...
        pleaseWait = new Image(GoTox.atlas.findRegion("please_wait"));
    ...
    private void levelCompleted() {
        ...
        GoTox.media.playSound("level_completed.ogg");
        GoTox.media.playMusic("level_win.ogg", false);
    }
