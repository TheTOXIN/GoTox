...
public class LevelIcon extends Group {
    ...
    public LevelIcon(int id) {
        ...
        hiliteImg = new Image(GoTox.atlas.findRegion("level_icon_hilite"));
        addActor(hiliteImg);
        hiliteImg.setVisible(true);

        bg = new Image(GoTox.atlas.findRegion("level_icon_bg"));
        addActor(bg);
        ...
        bgDown = new Image(GoTox.atlas.findRegion("level_icon_bg_down"));
        addActor(bgDown);
